...
# Due to github's limitation on the size of uploaded files, we split "TargetScan.txt" into 7 smaller files (“TargetScan1-7.txt”), which should be combined when used.
